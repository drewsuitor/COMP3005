...
app.listen(PORT, err => {
  if(err) console.log(err)
		...
		console.log(`http://localhost:3000/api/songs?title=Hotel`)
		console.log(`http://localhost:3000/api/songs?composer=Steve`)
		console.log(`http://localhost:3000/api/songs?title=Hotel&composer=Steve`)
		console.log(`http://localhost:3000/api/song/32`)
		}
})
